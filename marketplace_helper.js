...
// @version      0.8000
// @description  QoL features for the Dead Frontier Market. Displays the price per quantity of items (such as ammunition). And allows you to double click items in the inventory to add them to the search bar.
// @author       bogidot
...
(function() {
    ...
    setTimeout(() => {
        ...
        marketplace.addEventListener("dblclick", (e) => {
            ...
            if (e.target.className == "item" && is_buy_tab()) {
